...
class SingleThreadJavaHashMapOfTreeMapSpec extends TableBehaviors with NewSingleThreadJavaHashMapOfTreeMap

class QueuedJavaHashMapOfTreeMapSpec extends TableBehaviors with NewQueuedJavaHashMapOfTreeMap
